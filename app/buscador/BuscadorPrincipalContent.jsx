        ...
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <div className={styles.container}>
                ...
                <div className={styles.resultsSection}>
                    <h2>{loading ? 'Cargando...' : `${projects.length} Resultados Relacionados`}</h2>
                            ...
                            {projects.map(project => (
                                <div key={project.idproyecto} className={styles.projectItem}>
                                    <div className={styles.projectContent}>
                                        ...
                                        <p>Área de Investigación: {areasInvestigacion.find(a => a.id === project.id_area_investigacion)?.nomb_area || 'No especificada'}</p>
...
export default BuscadorPrincipalContent;
