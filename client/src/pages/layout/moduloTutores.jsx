...
const ModuloTutores = () => {
    ...
    const [students, setStudents] = useState([
        { id: 1, cedula: 'V30523083', firstName: 'Yander', secondName: '', lastName: 'Graterol', secondLastName: '', tipoTutor: 'Ing en Sistemas', actividad: 'Trabajo de Grado' }
    ]);
            ...
            <aside className={styles.sidebar}>
                ...
                <nav className={styles.sidebarNav}>
                    <ul>
                        ...
                        <li className={styles.active}><a href="http://localhost:3000/moduloEstudiantes"><i className="fas fa-user-graduate"></i> <span>Estudiantes</span></a></li>
